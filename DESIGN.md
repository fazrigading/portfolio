...
| :--- | :--- | :--- |
| `Layout` | `src/layouts/Layout.astro` | Astro static, holds `data-route`, vars, slot; fixed route-matched wallpaper page background (`src/assets/wallpapers/`, dimmed under gradient) |
